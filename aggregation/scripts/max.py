...
def main(args):
    ...
    # Aggregate using element-wise max along first axis (patches)
    # This preserves all other dimensions
    aggregated_features = np.max(patch_features, axis=0)
    ...
    print(f"Max aggregated features saved to {args.output_features}")
...
if __name__ == "__main__":
    description = "Max Aggregation for Organ Features"
