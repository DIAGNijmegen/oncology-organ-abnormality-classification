...
def load_model():
    config = {
        "name": "spectre-large-pretrained-novla",
        "backbone": "vit_large_patch16_128",
        "backbone_checkpoint_path_or_url": "https://huggingface.co/cclaess/SPECTRE/resolve/main/spectre_backbone_vit_large_patch16_128_no_vla.pt?download=true",
        "backbone_kwargs": {
            "num_classes": 0,
            "global_pool": '',
            "pos_embed": "rope",
        ...
        "description": "Pretrained SPECTRE model w/o VLA with ViT-Large backbone and feature combiner.",
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SPECTRE Feature Extraction for LEAVS without VLA")
